		...
		<section className='sm:py-32 py-20 sm:px-10 px-5 overflow-x-hidden'>
			<div className='screen-max-width'>
				...
				<div className='flex flex-col items-center'>
					...
					<p className='text-gray-700 font-semibold text-xl md:text-2xl py-10 text-center'>
				...
				<div className='flex md:flex-row flex-col justify-between items-start gap-24'>
					<div className='flex flex-1 justify-center flex-col'>
						...
						<p className=' text-gray-700 text-xl font-normal md:font-semibold g_fadeIn'>
							Mobile <span className='text-white'>games will look and feel so immersive</span>, with incredibly
							detailed environments and characters.
						</p>
					</div>

					<div className='flex-1 flex justify-center flex-col g_fadeIn'>
						<p className='text-gray-700 text-xl font-normal md:font-semibold'>New</p>
						<p className='text-white text-3xl md:text-5xl font-normal md:font-semibold my-2'>Pro-class GPU</p>
						<p className='text-gray-700 text-xl font-normal md:font-semibold'>with 6 cores</p>
					</div>
				</div>
			</div>
		</section>
